...
\section*{Liste des papiers}
Notre travail a amené à la publication de cinq articles.
\begin{itemize}
    \item Le premier article, nommée \textit{On local-global hysteresis-based hovering stabilization of the DarkO convertible UAV} \cite{sansouECC}, a été le résultat du travail de stage de six mois en amont de cette thèse. Il a été publié durant thèse car il contient un travail préliminaire à la bonne conduite de nos travaux. 
    ...
    \item Le quatrième est un article soumis dans le journal TCST. Le titre est \textit{Hovering stabilization of the DarkO tail-sitter drone with constant wind} \cite{sansouTCST} ert il synthétise le travail de modélisation, de commande et d'expérimentation réalisé sur Darko.
