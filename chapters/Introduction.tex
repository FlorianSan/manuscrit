...
Le chapitre \ref{chap:6DOF} étend le contrôleur proposé dans le chapitre précédent (chapitre \ref{chap:3DOF}) pour stabiliser la dynamique complète d'un drone \textit{tailsitter}. La méthode d'obtention des gains du contrôleur est basée sur un algorithme itératif permettant de   \cite{sansouTCST}
