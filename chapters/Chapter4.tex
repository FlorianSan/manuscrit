\chapter{Étude longitudinale sur une maquette à 3 DOF}
\minitoc
\label{chap:3DOF}
...
\todo{explication de la non mesure du vent}
...
\section{Contrôle linéaire, proportionnel-integral à 3 DOF}
\label{sec:3dofcmd}
...
\begin{figure}[ht!]
    ...
    \caption{Schéma de commande linéaire, proportionnel-integral.}
...
Le lien \url{https://youtu.be/ce4_FUzeVzI} montre une vidéo de la maquette avec les résultats expérimentaux.
\begin{figure}[!ht]
   \centering
