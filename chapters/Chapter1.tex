...
\nomenclature[]{\(PID\)}{Proportionnel Intégral Dérivé}
\nomenclature[]{\(ABAG\)}{Biais adaptatif et gain adaptatif \textit{Adaptive Bias and Adaptive Gain}}
\begin{figure}[ht!]
    \centering
    \resizebox{.9\textwidth}{!}{%
