...
\begin{figure}[ht!]
    ...
    \caption{Simulation du modèle complet \eqref{eq:dyna_orig} (ligne continue) et simplifié \eqref{eq:withouwind} (ligne pointillée) avec $\boldsymbol{u} = \boldsymbol{u}_{\text{lin}}$ défini dans 
...
le bruit des capteurs. La robustesse intrinsèque de la rétroaction hybride, établie dans le \cite[Chapitre 7]{65}, est confirmée par le maintien des performances, malgré le bruit de mesure.
