...
Plusieurs réflexions ont eu lieu pour conserver cette architecture, d'autres propositions ont été évalués, comme celle de faire un drone avec deux ailes en rotation libre (aile droite et gauche indépendante) problème d'estimation deux capteurs.
