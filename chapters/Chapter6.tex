...
\todo{Pourquoi W1, je ne dis pas que c'est faux mais il me semble que tu l'as évoqué que pour la marge de module. D'ailleurs W1 et W2 peuvenet simultanément servir à la performance ( bande passante, action dérivée en basses fréquences) et à la robustesse (MM). Il faudrait peut être expliciter un petit peu plus.}
